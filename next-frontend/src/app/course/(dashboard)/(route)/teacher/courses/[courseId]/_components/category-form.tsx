...
export const CategoryForm = ({initialData, courseId, options, onUpdate} : CategoryFormProps) => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            const course = await updateCourse(courseId, {categoryId: values.categoryId});
